...
class AppFaqButton extends StatefulWidget {
  final VoidCallback? onTap; // optional custom action

  const AppFaqButton({super.key, this.onTap});

  @override
  State<AppFaqButton> createState() => _AppFaqButtonState();
}

class _AppFaqButtonState extends State<AppFaqButton> {
  double _scale = 1.0;
    ...
    return GestureDetector(
      ...
      child: AnimatedScale(
        ...
        child: Container(
          ...
          child: AppIcons.svg(AppIcons.faq, size: 24, color: AppColors.black),
        ),
      ),
    );
  }
