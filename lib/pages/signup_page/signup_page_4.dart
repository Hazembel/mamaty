...
class _SignupPage4State extends State<SignupPage4> {
  ...
  void _validateAndContinue() {
    ...
    if ([passwordError, confirmPasswordError].every((e) => e == null)) {
      ...
      // Save password to shared signupData
      widget.signupData.password = controllers.passwordController.text;
  ...
  Future<void> _continue() async {
    ...
    debugPrint('✅ Password saved: ${widget.signupData.password}');
    widget.onFinish();
  }
  ...
  void initState() {
    ...
    controllers.passwordController.text = widget.signupData.password ?? '';
    controllers.confirmPasswordController.text = widget.signupData.password ?? '';
  }
